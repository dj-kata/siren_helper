...
class UIText:
    ...
    class feature:
        ...
        http_server_interface = 'HTTP viewer NIC:'
        http_server_interface_auto = 'Auto select'
        http_server_interface_missing = 'Currently not detected'
        ...
        capture_mode_direct = 'Direct capture (legacy API, Steam only)'
        capture_mode_fullscreen = 'DXGI direct capture (dxcam, Steam only)'
        ...
        dosukoi_alert_group = 'OCR Settings'
        dungeon_ocr_enabled = 'Enable floor identification'
        shop_ocr_enabled = 'Enable price identification'
    ...
    class obs:
        ...
        scene_collection_group = 'Scene Collection Settings'
    ...
    class main:
        ...
        waiting_capture = 'waiting'
        capture_ok = 'capturing'
