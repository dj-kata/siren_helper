...
class DetectOnShop:
    ...
    CROP_XYWH_TYPE0 = (965, 740, 720, 70)
    CROP_XYWH_TYPE1 = (720, 550, 630, 50)
    CROP_XYWH_TYPE2 = (780, 580, 700, 50)
    CROP_XYWH_TYPE3 = (865, 660, 720, 70)
...
class PosShopItemPrice:
    ...
    CROP_XYWH_TYPE0 = (240, 288, 700, 71)
    CROP_XYWH_TYPE1 = (180, 216, 510, 55)
    CROP_XYWH_TYPE2 = (196, 240, 540, 50)
    CROP_XYWH_TYPE3 = (220, 266, 620, 55)
    CROP_XYWH_BY_LIVE_MODE = {
        LIVE_EXPLORATION_MODE_NONE: CROP_XYWH_TYPE0,
        LIVE_EXPLORATION_MODE_1: CROP_XYWH_TYPE1,
        LIVE_EXPLORATION_MODE_2: CROP_XYWH_TYPE2,
...
class PosMyItems:
    ...
    CROP_XYWH_TYPE1 = (1501, 0, 419, 1080)
    CROP_XYWH_TYPE2 = (1597, 0, 323, 1080)
    CROP_XYWH_TYPE3 = (1, 1, 1, 1)
    CROP_XYWH_BY_LIVE_MODE = {
        LIVE_EXPLORATION_MODE_NONE: CROP_XYWH_TYPE0,
        LIVE_EXPLORATION_MODE_1: CROP_XYWH_TYPE1,
        LIVE_EXPLORATION_MODE_2: CROP_XYWH_TYPE2,
...
class PosItemIcons:
    ...
    CROP_XYWH_TYPE0 = (980, 683, 27, 23)
    CROP_XYWH_TYPE1 = (735, 512, 21, 18)
    CROP_XYWH_TYPE2 = (783, 546, 23, 19)
    CROP_XYWH_TYPE3 = (882, 614, 25, 22)
    CROP_XYWH_BY_LIVE_MODE = {
        LIVE_EXPLORATION_MODE_NONE: CROP_XYWH_TYPE0,
        LIVE_EXPLORATION_MODE_1: CROP_XYWH_TYPE1,
        LIVE_EXPLORATION_MODE_2: CROP_XYWH_TYPE2,
