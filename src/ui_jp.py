...
class UIText:
    ...
    class feature:
        ...
        http_server_interface = 'HTTP表示NIC:'
        http_server_interface_auto = '自動選択'
        http_server_interface_missing = '現在未検出'
        obs_enabled = 'OBS連携を有効にする'
        capture_mode = 'ゲーム画面取得方法:'
        capture_mode_none = '自動取得なし'
        capture_mode_obs = 'OBS経由'
        capture_mode_direct = '直接取得(従来API・Steam版のみ)'
        capture_mode_fullscreen = 'DXGI直接取得(dxcam・Steam版のみ)'
        ...
        dosukoi_alert_group = 'OCR設定'
        dungeon_ocr_enabled = 'フロア識別を有効にする'
        shop_ocr_enabled = '価格識別を有効にする'
        dosukoi_alert_enabled = 'ドスコイアラートを有効にする'
        dosukoi_alert_volume = 'アラート音量:'
        dosukoi_alert_threshold = 'ドスコイアラートしきい値:'
        entou_alert_enabled = '遠投状態アラートを有効にする'
